...
class InfiniteGridMenu {
  ...
  #render() {
    ...
    gl.enable(gl.DEPTH_TEST);
      ...
      gl.clearColor(0.478, 0.361, 0.980, 1);
...
useEffect(() => {
  ...
  const shuffledItems = [...(items.length ? items : defaultItems)].sort(() => 0.5 - Math.random());
  ...
  return (
    <div  className="relative w-full h-full ">
      ...
      {activeItem && (
        ...
        `}
          >
            <p className="select-none relative text-[#060010] top-[2px] desktop:text-[26px] mobile:text-[15px]">
              &#x2197;
            </p>
          </div>
        </>
